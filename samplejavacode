pipeline {
    ...
    environment {
        DOCKER_HUB_CREDENTIALS = '88f6634e-55ef-44e9-a932-6812ad3da066' // ID of Docker Hub credentials stored in Jenkins
        DOCKER_IMAGE = 'saikumar879087/java:latest' // Replace with your Docker Hub username and image name
    }
